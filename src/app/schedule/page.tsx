...
export default function SchedulePage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6">
      ...
      {/* Legend */}
      <div className="rounded-xl border border-neutral-700 bg-neutral-900/50 p-4 mb-6">
        <h2 className="mb-3 text-lg font-bold text-gold-300">Event Types</h2>
      ...
      <section className="mb-6">
        <h2 className="mb-3 text-lg font-bold text-gold-300">
          How to Participate
        </h2>
        <div className="rounded-xl border border-neutral-700 bg-neutral-900/50 p-4">
          <div className="space-y-4">
            <div>
              <h3 className="mb-2 font-semibold text-white text-sm">Arena Direct</h3>
      ...
      {/* Important Info */}
      <div className="rounded-xl border border-gold-700/50 bg-gold-900/20 p-4">
        <h3 className="font-semibold text-gold-300 mb-2 text-sm">Event Information</h3>
